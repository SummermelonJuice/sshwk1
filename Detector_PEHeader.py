...
def get_PEHeader_features(path):
    ...
    #print(len(strings))
    '''
    # store PEHeader features in dictionary form
    PEHeader_features = {}
    PEfile_Path = "path"
    pe = pefile.PE(PEfile_Path)
    for item in pe.IMAGE_OPTIONAL_HEADER32:
        if item.name != 'DataDirectory':
            PEHeader_features[item] = 1
